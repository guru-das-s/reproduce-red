...
EXAMPLE_DIRECTORIES = ['stats', 'energy', 'realtime', 'ipv6', 'routing', 'tcp', 'error-model', 'udp', 'matrix-topology', 'wireless', 'udp-client-server', 'socket', 'tutorial', 'naming']
...
NS3_EXECUTABLE_PATH = ['/nethome/gsrinagesh3/ns-allinone-3.24.1/ns-3.24.1/build/src/fd-net-device', '/nethome/gsrinagesh3/ns-allinone-3.24.1/ns-3.24.1/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-redhat-linux/4.4.7', '/nethome/gsrinagesh3/ns-allinone-3.24.1/ns-3.24.1/build']
...
cfg_files = ['/nethome/gsrinagesh3/ns-allinone-3.24.1/ns-3.24.1/build/ns3/config-store-config.h', '/nethome/gsrinagesh3/ns-allinone-3.24.1/ns-3.24.1/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
