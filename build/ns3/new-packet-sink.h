 ...
 * \defgroup newpacketsink NewNewPacketSink
 *
 * This application was written to complement OnOffApplication, but it
 * is more general so a NewNewPacketSink name was selected.  Functionally it is
 ...
 */
class NewPacketSink : public Application
{
public:
  /**
